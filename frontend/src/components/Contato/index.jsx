...
const Contato = () => {
    return (
        <>
            <div style={{ maxWidth: '1000px', maxHeight: '800px', overflow: 'auto', margin: '0 auto', marginTop: '70px' }}>
                <div style={{ justifyContent: 'center', marginBottom: '40px' }}>
                    <h2 className="text-center mb-4">Possui alguma dúvida ou sugestão? Entre em contato com a gente!</h2>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '40px', flex: '1' }}>
                    ...
                    <Stack direction="vertical" style={{ width: "35%" }}>
                        ...
                        <div>
                            <h4>Telefone</h4>
                            <p><TelephoneFill style={{ marginRight: '10px' }} /> +55 (21) 2566-3022</p>
                        </div>
                        <div>
                            <h4>Email</h4>
